...
public class SalesEngineWorkflow {

    private static Logger LOGGER = LoggerFactory.getLogger(SalesEngineWorkflow.class);
    ...
    public static void main(String[] args) throws IOException {
        ...
        final JavaPairRDD<DimensionRecord, Double> stateSalesPairReducedRDD = stateSalesPairRDD.reduceByKey(partitioner, (s1, s2) -> s1 + s2);
